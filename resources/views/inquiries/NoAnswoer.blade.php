                      ...
                      <form method="POST" action="{{route('calls.update',$inquiry->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <select  name="code"  class="custom-select form-control"  >
                                <option selected>{{$data->code}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select  name="code2"  class="custom-select form-control"  >
                                <option selected>{{$data->code2}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <label @if(app()->getLocale() == 'ar') style="display:flex;justify-content: right;align-items: center; " @endif for="recipient-name" class="col-form-label">{{__('input.note')}}</label>
